...
bot_token = os.environ.get("TOKEN", "6468414065:AAEOatye2CPWNv3YPnnpxUjbaSa94qYN_kM") 
api_hash = os.environ.get("HASH", "31dae8eac39b38583898e3bc78b96406") 
api_id = os.environ.get("ID", "29257953")
ss = os.environ.get("STRING", "BQG-cOEARkShe4cnlSe27w597vtMsGphOUF5Prst2XzgDQbxZgwVi7eWZUf5LvCzOpkSPxmrcHvcgt7o8plakSqrGCnXE4kPzRGthxxgSRES4YKvaNzgdP0dTLuWUQjdXDTi_Txn1YlCQmw5tNMddjS7q0g6-pDseBeJVOr3SeATbfSUbuGdjUySbGKSNIrqU6jSiJNWig8u-fH9Zf61sekCyEK-qARqmgNkZkUzm8xQw7eYJRbNJefZ0lYWhvRormhZvzv9hlj9fbkLOIn5mLCiACqON28abLLsUwmOc52JChBGDkUdg2vcrdgMc_wvIhMZs27j2P91RAAYWCOknYIYgVi5iAAAAAGCv37mAAoeD1JWv0IGmdgzw4KKDjkfvXlfG4SWMUvG4KX7Jcb5lw_SVbvFZmgrbTc8iS0-dkgrXL2X95PUpixEVmJX22DJdSdN9vDKPLP_0z-XP9sRhlbr9-VFWQicE7onjaWXLcw0HZiH7bIh5qXglFkOZ7CNa3D_VXFHi6UKL3rwcIK6tlcs_TyIIUrksi36n6w0TyRbNqlmegAAAAGCv37mAA")
...
async def account_login(bot: Client, m: Message):
 editable = await m.reply_text("**I am made by LPRPDV I am a simple save restricted bot**.\n\nSend message link to clone/download here\n Must join:- @LPRPDV")
